...
public class BookResource {
    ...
    /**
     * Service utilisé pour accéder aux données des livres et récupérer/modifier
     * leurs informations
     */
    ...
    /**
     * Endpoint permettant de publier les informations d'un livre dont la référence
     ...
     * (la requête patch doit fournir le nouveau statut sur livre, les autres
     * informations sont ignorées)
     * 
     * @param reference la référence du livre dont il faut changer le statut
     * @param book      le livre transmis en HTTP au format JSON et convertit en
     *                  objet Book

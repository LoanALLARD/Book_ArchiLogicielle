...
public class BookApplication extends Application {
    ...
    private BookRepositoryInterface openDbConnection() {
        ...
        try {
            db = new BookRepositoryMariadb(
                    "jdbc:mariadb://mysql-loanallardwebsite.alwaysdata.net/loanallardwebsite_library_db",
                    "loanallardwebsite_library_db", "-0RckPIQ");
        } catch (Exception e) {
     ...
     * 
     * @param bookRepo la connexion à la base de données instanciée dans la
